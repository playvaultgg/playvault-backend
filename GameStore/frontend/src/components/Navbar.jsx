...
const Navbar = () => {
    ...
    return (
        <motion.nav
            ...
            className="glass-panel sticky top-0 z-50 border-b-0 border-b border-[rgba(255,255,255,0.05)] shadow-[0_4px_30px_rgba(0,0,0,0.8)]"
        >
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                <Link to="/" className="text-[#d4af37] font-black text-2xl md:text-3xl tracking-widest uppercase hover:text-white transition-colors duration-300 drop-shadow-[0_0_15px_rgba(212,175,55,0.6)]" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                    PLAY<span className="text-white">VAULT</span>
                </Link>

                <div className="hidden lg:flex space-x-10 text-gray-400 font-bold text-xs tracking-[0.2em] uppercase">
                ...
                <div className="flex items-center space-x-4 md:space-x-6">
                    ...
                    <button className="lg:hidden text-white hover:text-[#d4af37] transition-colors touch-target" onClick={() => setMobileMenuOpen(true)}>
                    ...
                    <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                        <Link to="/cart" className="relative text-gray-400 hover:text-[#d4af37] transition-all p-2.5 bg-[#111] border border-[rgba(255,255,255,0.05)] rounded-full hover:border-[#d4af37] shadow-lg flex items-center justify-center group">
                            <ShoppingCart className="w-5 h-5 group-hover:drop-shadow-[0_0_8px_rgba(212,175,55,0.8)]" />
                            <AnimatePresence>
                                {cartItems.length > 0 && (
                                    <motion.span
                                        initial={{ scale: 0 }}
                    ...
                    {user ? (
                        <div className="relative hidden lg:block">
                            <motion.button
                                ...
                                className="flex items-center space-x-2 text-[#d4af37] font-black uppercase tracking-widest text-[11px] hover:text-white transition-all p-2.5 px-4 bg-[rgba(212,175,55,0.1)] border border-[rgba(212,175,55,0.3)] rounded-full shadow-[0_0_15px_rgba(212,175,55,0.1)] hover:shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                            >
                                <span className="drop-shadow-[0_0_5px_rgba(212,175,55,0.5)]">{user.name}</span>
                            </motion.button>
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-black/80 z-[60] backdrop-blur-md lg:hidden"
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-[#050505] w-[80%] max-w-sm h-full border-r border-[#d4af37]/20 p-6 flex flex-col shadow-[0_0_50px_rgba(212,175,55,0.1)]"
